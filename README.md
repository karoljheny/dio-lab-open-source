...
4.Crie uma nova **branch** e nomeie como `feat/communit/seunomedeusuario`: `git checkout -b feat/communit/seunomedeusuario`;
> Exemplo: `git checkout -b feat/communit/karoljheny`
> [!NOTE]   
